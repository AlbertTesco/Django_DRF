...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('studies', '0003_course_owner_lesson_owner'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscribers', to='studies.course', verbose_name='Курс')),
